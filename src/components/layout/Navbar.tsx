...
const navLinks = [
  ...
  { href: "/cek-reservasi", label: "Cek Reservasi" },
  { href: "/faq", label: "FAQ" },
...
export function Navbar({ whatsapp }: Props) {
  ...
  return (
    <>
      <nav className="bg-white/95 backdrop-blur-md border-b border-border-soft sticky top-0 z-50 shadow-sm">
      ...
      {/* Mobile Nav - Full screen overlay (outside nav to avoid backdrop-filter containing block issue) */}
      {isOpen && (
